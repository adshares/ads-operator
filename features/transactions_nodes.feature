Feature: Transactions
  ...
  Scenario: List transactions by invalid node id
    Given I want to get the list of "blockexplorer/nodes/1001/transactions"
    When I request resource
    Then the response status code should be 200
    And the response should contain:
   """
  ...
  Scenario: List transactions by invalid node id
    Given I want to get the list of "blockexplorer/nodes/100*/transactions"
    When I request resource
  ...
  Scenario: List transactions by invalid node id
    Given I want to get the list of "blockexplorer/nodes/transactions"
    When I request resource
    Then the response status code should be 422
    And the response should contain:
   """
  ...
  Scenario: List transactions by invalid node id
   ...
   """
      {
        "code":404,
        "message":"No route found for \"GET \/api\/v1\/blockexplorer\/nodes\/\/transactions\""
      }
   """