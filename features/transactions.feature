...
#      | 1B6180E0 | 1       | aa        | 0001   |   1  | 1    |         |    |

#    Given "emptyTransactions" exist in application:
#      | id       | blockId | messageId | nodeId | type | size |
#      | 2B6180E0 | 0001    | aa        | 0001   |   1  | 1    |

    Given "transactions" exist in application:
      | id       | blockId | messageId | nodeId | type | size |
      | 2B6180E0 | 0001    | aa        | 0001   |   1  | 1    |
...
#  port:
  ...
  Scenario: List all available transactions without sort and pagination
...
#    """
  ...
  Scenario: Get single transactions
    Given I want to get the resource "blockexplorer/transactions" with id "1B6180E0"
    When I request resource
    Then the response status code should be 200
    And the response should contain:
    """
  ...
  Scenario: Unable to get non-existent resource
    Given I want to get the resource "blockexplorer/transactions" with id "9B6180E0"
    When I request resource
